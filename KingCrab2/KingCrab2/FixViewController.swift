...
//         }
    ...
    let fiximageg = UIImageView().then {
        $0.image = .fix1
    }
    let postdelete = UIImageView().then {
        $0.image = .postdelete
    }
    let realpostdelete = UIImageView().then {
        $0.image = .realpostdelete
    }
    ...
    func layout() {
        ...
        realpostdelete.snp.makeConstraints {
...
//        }
    ...
    @objc func okButtonTapped() {
        let fixViewController = WriteViewController()
